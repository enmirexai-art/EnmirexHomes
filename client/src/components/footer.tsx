    ...
    <>
      ...
      <section className="py-12 sm:py-16 lg:py-20 gradient-primary text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6">Ready to Sell Your Home Fast?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-6 sm:mb-8">
            ...
            <div className="text-center">
              <div className="text-xs sm:text-sm text-white/70 mb-1">Or call us directly:</div>
              <a 
      ...
      {/* Footer */}
      <footer className="text-white py-8 sm:py-12" style={{ backgroundColor: 'hsl(218, 100%, 12%)' }}>
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div>
              <div className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-secondary">Enmirex Homes</div>
              ...
              <div className="text-base sm:text-lg font-semibold">Call us today:</div>
              <a 
                href="tel:(555) 123-4567" 
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">We Buy Homes In</h3>
              <ul className="space-y-2 text-sm sm:text-base text-gray-300">
                <li>Any Condition</li>
                <li>Any Situation</li>
                <li>Foreclosure</li>
